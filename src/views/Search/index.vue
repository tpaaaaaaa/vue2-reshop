        ...
        <div class="main">
            <div class="py-container">
                ...
                <div class="clearfix selector">
                    <div class="type-wrap logo">
                        ...
                        <div class="value logos">
                            <ul class="logo-list">
                                <li v-for="trade of trademarkList" :key="trade.tmId">
                                    {{ trade.tmName }}
                                </li>
                    ...
                    <div class="type-wrap" v-for="attrs of attrsList" :key="attrs.attrId">
                        ...
                        <div class="fl value">
                            <ul class="type-list">
                                <li v-for="(attr, index) of attrs.attrValueList" :key="index">
                                    <a>{{ attr }}</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="details clearfix">
                    ...
                    <!-- 分页 -->
                    <PaginationComponent :pageInfo="pageInfo"></PaginationComponent>
...
export default {
    ...
    computed: {
        ...mapGetters('search', ['trademarkList', 'pageInfo', 'attrsList', 'goodsList'])
    }
};
</script>
